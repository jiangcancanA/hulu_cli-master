  ...
  <view class="ranking">
    <view class="ranking-header">
      <!-- <view class="header-tabs">
        <view class="tabs-text">筛选方案：</view>
        <view class="tabs-tab" :class="{'tab-active': activeTab == '默认'}" @click="changeSearchTab('默认')">默认</view>
        <view class="tabs-tab" :class="{'tab-active': activeTab == '贴纸'}" @click="changeSearchTab('贴纸')">贴纸</view>
        <view class="tabs-tab" :class="{'tab-active': activeTab == '热门租赁'}" @click="changeSearchTab('热门租赁')">热门租赁</view>
      </view> -->
      <view class="header-search">
        <view class="search-left">
          <u-search class="left-input" fontSize="28rpx" searchIconSize="34rpx" placeholderColor="#DCDEDF80" :showAction="false" :inputStyle="inputStyle" shape="square" bgColor="#142C44"
            borderColor="none" color="#fff80" placeholder="搜索..." v-model="search" @click="searchData"></u-search>
          <view class="search-btn">搜索</view>
        </view>
        <view class="search-right" @click="openHighSearch">高级筛选</view>
      </view>
    </view>
    <view class="ranking-table">
      ...
      <view class="home-ranking-table">
        <uni-table style="min-width: 1000rpx;" :stripe="false" emptyText="暂无更多数据">
          <!-- 表头行 -->
          <uni-tr>
            <uni-th align="center"><view style="font-size: 20rpx;min-width: 40rpx;">排行</view></uni-th>
    ...
    <!-- 高级筛选 -->
    <high-search v-if="highSearchPopup" :filterInfo="filterInfo" @closeHighSearch="closeHighSearch" @selectData="selectData"/>
  </view>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    // 打开高级筛选
    openHighSearch() {
      this.highSearchPopup = true
      if (!this.highSearchPopup) {
        // this.filterInfo = {}
        this.closeNum++
      }
    },
